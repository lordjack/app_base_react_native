...
export default function ModeloAsyncStorageList({ navigation }) {
  ...
  const ListagemProdutos = () => (
    <>
        ...
        <List
          ...
          {data?.map((item, index) => (
            <List.Item
              ...
              onPress={() => {
                item.id = index
                navigation.navigate('ModeloAsyncStorageForm', { item: item || null });
      ...
      <Fab
        ...
        onPress={() => navigation.navigate('ModeloAsyncStorageForm', { item: '' })}
      />
    </>
  );
