...
export default class ImagesSelectScreen extends Component {
    ...
    imagesCallback = (callback) => {
        ...
        callback
            .then(async (photos) => {
                ...
                navigation.navigate("ProdutoForm", {images: cPhotos});
            })
    ...
    _renderDoneButton = (count, onSubmit) => {
        ...
        return (
            <TouchableOpacity title={"Done"} onPress={onSubmit}>
                <Text onPress={onSubmit}>Finalizar</Text>
            </TouchableOpacity>
        );
    };
    ...
    updateHandler = (count, onSubmit) => {
        this.props.navigation.setOptions({
            title: ` ${count} Imagen(s) selecionadas`,
